                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <select class="form-control" name="status_id" required>
                                <option value="{{ $user->status_user_id }}">{{ $user->statusUser->status_user }}</option>
                                @foreach ($status->where('id_status_user','!=',$user->status_user_id) as $row)
                                <option value="{{ $row->id_status_user }}">{{ $row->status_user }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
