...
<section class="content-header">
    <div class="container">
        <div class="row mb-2">
            <div class="col-sm-8">
                <h1 class="text-capitalize font-weight-bold">Validasi Usulan <small class="text-sm">({{ $usulan->id_usulan }})</small></h1>
                <h4 class="small text-muted mt-2">
                    Mohon untuk berkordinasi dengan <b>Petugas Gudang</b> untuk mengecek ketersediaan barang. <br>
                    Jika barang tidak tersedia, silahkan isi dengan 0.
                </h4>
            </div>
...
<section class="content">
    <div class="container">
        ...
        <form id="form" action="{{ route('atk.validation.store', ['form' => $form, 'id' => $id]) }}" method="POST">
            @csrf
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 form-group">
                            <label>Tanggal : <br> {{ \Carbon\carbon::parse($usulan->tanggal_usulan)->isoFormat('DD MMMM Y') }}</label>
                            <input type="hidden" name="nomor_usulan" value="{{ $usulan->nomor_usulan }}">
                            <input type="hidden" name="tanggal_usulan" value="{{ $usulan->tanggal_usulan }}">
                        </div>
                        @else
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" class="form-control form-control-sm text-center bg-white " name="permintaan[]" value="{{ $row->jumlah_permintaan }}" readonly>
                                </td>
                                <td>
                                    <div class="input-group mt-1">
                                        ...
                                        @php $jumlahDisetujui = $row->jumlah_disetujui ? $row->jumlah_disetujui : $row->jumlah_permintaan; @endphp
                                        <input type="text" class="form-control form-control-sm text-center bg-white number" id="disetujui-{{ $row->id_permintaan }}" name="disetujui[]" value="{{ $jumlahDisetujui }}" min="1">
