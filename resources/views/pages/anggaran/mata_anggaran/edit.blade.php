        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right text-capitalize">
                    ...
                    <li class="breadcrumb-item active">Edit Mata Anggaran {{ $id == 'ctg' ? 'Kategori' : $id }}</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="card card-primary card-outline">
            <div class="card-header text-capitalize">
                <h3 class="card-title">Edit Mata Anggaran {{ $id == 'ctg' ? 'Kategori' : $id }}</h3>
            ...
            <form action="{{ route('mata_anggaran.edit', ['ctg' => $id, 'id' => $mta->id_mta]) }}" method="POST">
                @csrf
                <div class="card-body">
                    @if ($id == '*')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select id="mata-anggaran" name="mta_id" class="form-control">
                                <option value="{{ $mta->mta_id }}">{{ $mta->kode_mta_id.'. '.$mta->nama_mta_id }}</option>
                            </select>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="kode_mta" value="{{ $mta->kode_mta }}" required>
                        </div>
                    </div>
                    @if ($id != 5)
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="nama_mta" value="{{ $mta->nama_mta }}" required>
                        </div>
                    </div>
                    @endif
                </div>
