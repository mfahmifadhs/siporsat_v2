        ...
        <div class="row">
                    ...
                    <div class="col-md-3 col-12">
                        <div class="small-box bg-info">
                            ...
                            <div class="text-center p-2 border border-top">
                                <form action="{{ route('usulan.show','aadb') }}" method="POST">
                                    @csrf
            ...
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('usulan.show', 'aadb') }}" class="btn btn-default border-secondary p-4 btn-block">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('realisasi.show', ['form' => 'aadb', 'ukerId' => Auth::user()->pegawai->unit_kerja_id]) }}" class="btn btn-default border-secondary p-4 btn-block">
                            <i class="fas fa-file-alt fa-3x"></i>
                            <h6 class="mt-3 font-weight-bolder">Anggaran</h6>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="{{ route('usulan.report', 'aadb') }}" class="btn btn-default border-secondary p-4 btn-block">
            ...
            <div class="col-md-6">
                <div class="form-group row">
                    <h6 class="text-left col-md-12">Daftar AADB</h6>
                    <div class="col-md-6">
                        <a href="{{ route('aadb.kendaraan.show') }}" class="btn btn-default border-secondary p-4 btn-block">
                            <i class="fas fa-car-on fa-3x"></i>
                            <h6 class="mt-3 font-weight-bolder">Daftar AADB</h6>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="{{ route('aadb.kategori.show') }}" class="btn btn-default border-secondary p-4 btn-block">
                            <i class="fas fa-car fa-3x"></i>
                            <h6 class="mt-3 font-weight-bolder">Kategori AADB</h6>
                        </a>
                    </div>
                </div>
            </div>
