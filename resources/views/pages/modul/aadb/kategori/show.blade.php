        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb text-capitalize">
                    ...
                    <li class="breadcrumb-item active">Kategori Alat Angkutan Darat & Bermotor</li>
                </ol>
            </div>
            @if(Auth::user()->role_id == 1)
            <div class="col-sm-6 mt-3">
                <div class="form-group text-right">
                    <a href="{{ route('aadb.kategori.create') }}" class="btn btn-add">
    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                <label class="card-title">Daftar Kategori Alat Angkutan Darat Bermotor</label>
            </div>
            <div class="card-body">
                <table id="table-show" class="table table-bordered table-striped" style="font-size: 15px;">
                    ...
                    <tbody class="text-capitalize">
                        ...
                        <tr>
                            ...
                            <td class="pt-3">{{ $row->kategori_aadb }}</td>
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item btn" type="button" href="{{ route('aadb.kategori.edit', $row->id_kategori) }}">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a class="dropdown-item btn" type="button" href="{{ route('aadb.kategori.delete', $row->id_kategori) }}" onclick="confirmHapus(event)">
