    ...
    <div class="container">
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                <label class="card-title">Tambah Kategori AADB</label>
            </div>
            <form id="form" action="{{ route('aadb.kategori.create') }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control input-border-bottom" name="kategori_aadb" placeholder="Contoh : Mini Bus" required>
                        </div>
                    </div>
                </div>
