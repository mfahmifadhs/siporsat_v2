    ...
    <div class="container">
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                <label class="card-title">Edit Alat Angkutan Darat Bermotor (AADB)</label>
            ...
            <form id="form" action="{{ route('aadb.kendaraan.update', $aadb->id_kendaraan) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <select class="col-md-9 form-control" name="unit_kerja_id" required>
                            ...
                            @foreach($uker as $row)
                            <option value="{{ $row->id_unit_kerja }}" <?php echo $row->id_unit_kerja == $aadb->unit_kerja_id ? 'selected' : '' ?>>
                    ...
                    <div class="form-group row">
                        ...
                        <select class="col-md-9 form-control" name="kategori" required>
                            ...
                            <option value="{{ $row->kode_kategori }}" <?php echo $row->kode_kategori == $aadb->kategori_id ? 'selected' : '' ?>>
                    ...
                    <div class="form-group row">
                        ...
                        <select class="col-md-9 form-control" name="kualifikasi" required>
                            ...
                            <option value="{{ $row }}" <?php echo $row == $aadb->kualifikasi ? 'selected' : '' ?>>
                                {{ ucfirst($row) }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" class="col-md-9 form-control" name="merktipe" value="{{ $aadb->merk_tipe }}" placeholder="Contoh: Suzuki Ertiga" required>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Keterangan*</label>
                        <input type="text" class="col-md-9 form-control" name="keterangan" value="{{ $aadb->keterangan }}" placeholder="Contoh: Kendaraan Operasional Menteri" required>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Jenis AADB</label>
                        <div class="col-md-1 col-form-label">
                            <input type="radio" class="" name="jenis_aadb" value="bmn" <?php echo $aadb->jenis_aadb == 'bmn' ? 'checked' : '' ?>>
                            <span>BMN</span>
                        </div>
                        <div class="col-md-3 col-form-label">
                            <input type="radio" class="" name="jenis_aadb" value="sewa" <?php echo $aadb->jenis_aadb == 'sewa' ? 'checked' : '' ?>>
                            <span>Sewa</span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">No. Plat*</label>
                        <input type="text" class="col-md-3 form-control text-center" name="no_plat" value="{{ $aadb->no_plat }}" required>
                        <label class="col-md-3 col-form-label text-center">No. Plat Dinas</label>
                        <input type="text" class="col-md-3 form-control text-center" name="no_plat_dinas" value="{{ $aadb->no_plat_dinas }}">
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Masa Berlaku STNK</label>
                        <input type="date" class="col-md-3 form-control text-center" name="tanggal_stnk" value="{{ $aadb->tanggal_stnk }}">
                        <label class="col-md-3 col-form-label text-center">Tahun Kendaraan</label>
                        <input type="number" class="col-md-3 form-control text-center" name="tahun" value="{{ $aadb->tahun }}">
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Nilai Perolehan (Rp)</label>
                        <input type="text" class="col-md-3 form-control price text-center" name="nilai_perolehan" value="{{ number_format($aadb->nilai_perolehan, 0, ',', '.') }}">
                        <label class="col-md-3 col-form-label text-center">Tanggal Perolehan</label>
                        <input type="date" class="col-md-3 form-control text-center" name="tanggal_perolehan" value="{{ $aadb->tanggal_perolehan }}">
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Nomor BPKB</label>
                        <input type="text" class="col-md-3 form-control" name="no_bpkb" value="{{ $aadb->no_bpkb }}">
                        <label class="col-md-3 col-form-label text-center">Nomor Rangka</label>
                        <input type="text" class="col-md-3 form-control" name="no_rangka" value="{{ $aadb->no_rangka }}">
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label text-center">Nomor Mesin</label>
                        <input type="text" class="col-md-3 form-control" name="no_mesin" value="{{ $aadb->no_mesin }}">
                        ...
                        <select class="col-md-3 form-control" name="kondisi">
                            ...
                            <option value="{{ $row->id_kondisi }}" <?php echo $row->id_kondisi == $aadb->kondisi_id ? 'selected' : ''?>>
                                {{ $row->nama_kondisi }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group row">
                        ...
                        <select class="col-md-3 form-control" name="status">
                            ...
                            <option value="{{ $row->id_status }}" <?php echo $row->id_status == $aadb->status_id ? 'selected' : ''?>>
                                {{ $row->nama_status }}
                            </option>
                            @endforeach
                        </select>
                        ...
                        <div class="col-md-3 btn btn-default btn-file border-secondary">
                            ...
                            <input type="file" name="foto_kendaraan" class="image-aadb">
                            <img id="preview-image-aadb" src="{{ $aadb->foto_kendaraan ? asset('storage/files/foto_kendaraan/'. $aadb->foto_kendaraan) : '' }}" style="max-height: 80px;">
