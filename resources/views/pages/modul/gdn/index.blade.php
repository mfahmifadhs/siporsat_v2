        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right text-capitalize">
                    <li class="breadcrumb-item">Gedung & Bangunan</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
                    ...
                    <div class="col-md-3 col-12">
                        <div class="small-box bg-info">
                            ...
                            <div class="text-center p-2 border border-top">
                                <form action="{{ route('usulan.show','gdn') }}" method="POST">
                                    @csrf
            ...
            <div class="col-md-6 mt-5">
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('usulan.show', 'gdn') }}" class="btn btn-default border-secondary p-4 btn-block">
            ...
            <div class="col-md-6 mt-5">
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('realisasi.show', ['form' => 'gdn', 'ukerId' => Auth::user()->pegawai->unit_kerja_id]) }}" class="btn btn-default border-secondary p-4 btn-block">
                            <i class="fas fa-file-alt fa-3x"></i>
                            <h6 class="mt-3 font-weight-bolder">Anggaran</h6>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="{{ route('usulan.report', 'gdn') }}" class="btn btn-default border-secondary p-4 btn-block">
