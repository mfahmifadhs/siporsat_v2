    ...
    <div class="container">
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                <label class="card-title">Edit BMN Olah Data & Meubelair</label>
            ...
            <form id="form" action="{{ route('oldat.barang.update', $barang->id_barang) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <select class="col-md-5 form-control" name="kategori_id" required>
                            ...
                            <option value="{{ $row->kode_kategori }}" <?php echo $row->kode_kategori == $barang->kategori_id ? 'selected' : '' ?>>
                                {{ $row->kode_kategori.' - '.$row->kategori_barang }}
                            </option>
                            @endforeach
                        </select>
                        <label class="col-md-2 col-form-label text-center">NUP*</label>
                        <input type="number" class="col-md-2 form-control text-center" name="nup" value="{{ $barang->nup }}" min="1" required>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Merk/Tipe*</label>
                        <input type="text" class="col-md-9 form-control" name="merktipe" value="{{ $barang->merk_tipe }}" placeholder="Contoh: Asus/Lenovo" required>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Spesifikasi</label>
                        <input type="text" class="col-md-9 form-control" name="spesifikasi" value="{{ $barang->spesifikasi }}" placeholder="Contoh: RAM 8, SSD 256">
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Nilai Perolehan</label>
                        <input type="text" class="col-md-3 form-control price" value="{{ number_format($barang->nilai_perolehan, 0, ',', '.') }}" name="nilai">
                        <label class="col-md-3 col-form-label text-center">Tanggal Perolehan</label>
                        <input type="date" class="col-md-3 form-control" value="{{ $barang->tahun_perolehan }}" name="tanggal">
                    </div>
                    <div class="form-group row">
                        ...
                        <select class="col-md-3 form-control" name="kondisi">
                            ...
                            <option value="{{ $row['id'] }}" <?php echo $row['id'] == $barang->kondisi_id ? 'selected' : '' ?>>
                                {{ $row['val'] }}
                            </option>
                            @endforeach
                        </select>
                        ...
                        <select class="col-md-3 form-control" name="status">
                            ...
                            <option value="{{ $row['id'] }}" <?php echo $row['id'] == $barang->status_id ? 'selected' : ''?>>
                                {{ $row['val'] }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3 btn btn-default btn-file border-secondary">
                            ...
                            <img id="preview-image-barang" src="{{ asset('storage/files/foto_barang/'. $barang->foto_barang) }}" style="max-height: 80px;">
