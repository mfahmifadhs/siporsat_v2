    ...
    <div class="container">
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                <label class="card-title">Edit Kategori BMN</label>
            </div>
            <form id="form" action="{{ route('oldat.kategori.edit', $id) }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control input-border-bottom" name="kategori_barang" value="{{ $kategori->kategori_barang }}"d>
                        </div>
                    </div>
                </div>
